...
begin
  ...
  Jeweler::Tasks.new do |gem|
    ...
    gem.add_dependency('royw-roys_extensions','>= 0.0.4')
    gem.add_dependency('royw-imdb','>= 0.1.6')
    gem.add_dependency('royw-tmdb','>= 0.1.7')
    gem.add_dependency('royw-dvdprofiler_collection','>= 0.1.5')
